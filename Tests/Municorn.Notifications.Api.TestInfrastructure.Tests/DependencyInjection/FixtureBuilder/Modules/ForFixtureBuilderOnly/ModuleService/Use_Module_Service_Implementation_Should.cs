...
namespace Municorn.Notifications.Api.TestInfrastructure.Tests.DependencyInjection.FixtureBuilder.Modules.ForFixtureBuilderOnly.ModuleService
{
    ...
    internal class Use_Module_Service_Implementation_Should
    {
        [Test]
        [Repeat(2)]
        public void Case([InjectParameterDependency] IMockService service) => service.Should().NotBeNull();

        [TestCase(10)]
        [TestCase(11)]
        [Repeat(2)]
        public void Cases([InjectParameterDependency] IMockService service, int value) => service.Should().NotBeNull();
    }
}
